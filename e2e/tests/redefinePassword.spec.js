...
test("deve alterar a senha do usuário com sucesso", async ({ page }) => {
  ...
  const hasRedefinePasswordSuccess = await page.getByText(
    "senha alterada com sucesso.",
  );
  await expect(hasRedefinePasswordSuccess).toBeVisible();
});

test("deve mostrar mensagem de erro ao tentar alterar senha do usuário com o campo senha incorreta", async ({
  page,
}) => {
  // Go to http://localhost:3000/
  await page.goto("http://localhost:3000/");
  ...
  const hasRedefinePasswordWrong = await page.getByText(
    "senha preenchida é incorreta.",
  );
  await expect(hasRedefinePasswordWrong).toBeVisible();
});

test("deve mostrar mensagem de erro ao tentar alterar senha do usuário com o campo senha vazio", async ({
  page,
}) => {
  // Go to http://localhost:3000/
  await page.goto("http://localhost:3000/");
...
test("deve mostrar mensagem de erro ao tentar alterar senha do usuário com o campo nova senha inválida", async ({
  ...
  const hasRedefinePasswordWrong = await page.getByText(
    "Campo nova senha deve conter no mínimo 4 caracteres",
  );
  await expect(hasRedefinePasswordWrong).toBeVisible();
});

test("deve mostrar mensagem de erro ao tentar alterar senha do usuário com o campo senha atual e nova senha iguais", async ({
  page,
}) => {
  // Go to http://localhost:3000/
  await page.goto("http://localhost:3000/");
  ...
  const hasRedefinePasswordWrong = await page.getByText(
    "Campos senha atual e nova senha devem ser diferentes",
  );
  await expect(hasRedefinePasswordWrong).toBeVisible();
});

test("deve mostrar mensagem de erro ao tentar alterar senha do usuário com o campo nova senha sem seguir requisitos", async ({
  page,
}) => {
  // Go to http://localhost:3000/
  await page.goto("http://localhost:3000/");
...
test("deve mostrar mensagem de erro ao tentar alterar senha do usuário com o campo confirmar nova senha vazio", async ({
  page,
}) => {
  // Go to http://localhost:3000/
  await page.goto("http://localhost:3000/");
...
test("deve mostrar mensagem de erro ao tentar alterar senha do usuário com o campo confirmar nova senha inválido", async ({
  page,
}) => {
  // Go to http://localhost:3000/
  await page.goto("http://localhost:3000/");
  ...
  const hasRedefinePasswordWrong = await page.getByText(
    "Campo confirmar nova senha é inválido",
  );
  await expect(hasRedefinePasswordWrong).toBeVisible();
});

test("deve mostrar mensagem de erro ao tentar alterar senha do usuário com o campo nova senha e confirmar nova senha diferentes", async ({
  page,
}) => {
  // Go to http://localhost:3000/
  await page.goto("http://localhost:3000/");
