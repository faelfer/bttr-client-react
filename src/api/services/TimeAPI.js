...
export async function TimesByPageFetch(tokenAuthorization, page) {
  console.log(
    "TimesByPageFetch | tokenAuthorization, page:",
    tokenAuthorization,
    page,
  );
  const configRequest = {
...
export async function TimeByIdFetch(tokenAuthorization, timeID) {
  console.log(
    "TimeByIdFetch | tokenAuthorization, timeID:",
    tokenAuthorization,
    timeID,
  );
  const configRequest = {
...
export async function TimeCreateFetch(tokenAuthorization, skillID, minutes) {
  console.log(
    "TimeCreateFetch | tokenAuthorization, skillID, minutes:",
    tokenAuthorization,
    skillID,
    minutes,
  );
...
export async function TimeDeleteByIdFetch(tokenAuthorization, timeID) {
  console.log(
    "TimeDeleteByIdFetch | tokenAuthorization, timeID:",
    tokenAuthorization,
    timeID,
  );
  const configRequest = {
