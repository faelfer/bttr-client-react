...
export async function SkillsFromUserFetch(tokenAuthorization, page) {
  console.log(
    "SkillsFromUserFetch | tokenAuthorization, page:",
    tokenAuthorization,
    page,
  );
  const configRequest = {
...
export async function SkillsByPageFetch(tokenAuthorization, page) {
  console.log(
    "SkillsByPageFetch | tokenAuthorization, page:",
    tokenAuthorization,
    page,
  );
  const configRequest = {
...
export async function SkillByIdFetch(tokenAuthorization, skillID) {
  console.log(
    "SkillByIdFetch | tokenAuthorization, skillID:",
    tokenAuthorization,
    skillID,
  );
  const configRequest = {
...
export async function SkillCreateFetch(tokenAuthorization, name, timeDaily) {
  console.log(
    "SkillCreateFetch | tokenAuthorization, name, timeDaily:",
    tokenAuthorization,
    name,
    timeDaily,
  );
...
export async function SkillUpdateByIdFetch(
  ...
  console.log(
    "SkillUpdateByIdFetch | tokenAuthorization, name, timeDaily:",
    tokenAuthorization,
    name,
    timeDaily,
  );
...
export async function SkillDeleteByIdFetch(tokenAuthorization, skillID) {
  console.log(
    "SkillDeleteByIdFetch | tokenAuthorization, skillID:",
    tokenAuthorization,
    skillID,
  );
  const configRequest = {
